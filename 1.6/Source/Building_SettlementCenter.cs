...
namespace DanielRenner.SettledIn
{
    ...
    public class Building_SettlementCenter : Building_FrameRecreationConstruction
    {
        ...
        public override void SpawnSetup(Map map, bool respawningAfterLoad)
        {
            ...
            // we don't need a finished def and override the work required
            workRequired = 20000;
            finishedDef = null;
            ...
            if (settledInComponent != null && !settledInComponent.SettlementCenterAlreadyBuiltBefore)
            {
                settledInComponent.SettlementCenterAlreadyBuiltBefore = true;
                var letter = LetterMaker.MakeLetter("DanielRenner.SettledIn.SettlementCenterLetterTitle".Translate(), "DanielRenner.SettledIn.SettlementCenterLetterContents".Translate(), LetterDefOf.PositiveEvent);
        ...
        /// <summary>
        /// Dev method to trigger completion through dev gizmo
        /// </summary>
        public void DevBeginUpgrading()
        {
            BeginUpgrading();
        }
        ...
        /// Dev method to trigger completion through dev gizmo
        /// </summary>
        public void DevComplete()
        {
            Complete();
        }

        public void DevIncrementUpgrade()
        {
            progress += 1000;
            DoRecreationWork(null);
        }
        ...
        public void DevCreateTale()
        {
            ...
            {
                Log.Debug("failed recording new event");
            }
        }
