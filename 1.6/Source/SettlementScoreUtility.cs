...
namespace DanielRenner.SettledIn
{
    ...
    public static class SettlementScoreUtility
    {
        ...
        static SettlementScoreUtility()
        {
            ...
            /* Dining Room */
            OverrideLabels.Add(DefDatabase<RoomRoleDef>.GetNamed("DiningRoom").defName, "Dining Room");
            OverrideDescriptions.Add(DefDatabase<RoomRoleDef>.GetNamed("DiningRoom").defName, "A place to eat and enjoy your meals. Contains tables and chairs to sit on while enjoying the meals.");
            ...
            /* Laboratory */
            OverrideDescriptions.Add(DefDatabase<RoomRoleDef>.GetNamed("Laboratory").defName, "The laboratory is where the brains are put to work!\nContains research buildings.");
            ...
            /* RecRoom */
            OverrideLabels.Add(DefDatabase<RoomRoleDef>.GetNamed("RecRoom").defName, "Recreation Room");
            OverrideDescriptions.Add(DefDatabase<RoomRoleDef>.GetNamed("RecRoom").defName, "A place to spend your measly short free time and enjoy tv, games or simply contemplating in silence or with some good music from the boom box. Contains recreation buildings of all kind.");
