...
namespace DanielRenner.SettledIn
{
    class CompAssignableToPawn_ProductionBuilding : CompAssignableToPawn
    {
        ...
        {
            Log.DebugOnce("CompAssignableToPawn_ProductionBuilding.CompAssignableToPawn_ProductionBuilding() at least comps are getting created...");
        }
        ...
        {
            Log.DebugOnce($"CompAssignableToPawn_ProductionBuilding.DrawGUIOverlay() is getting called for {parent.def}... ");
            base.DrawGUIOverlay();
        }
