    ...
    */
    ...
    static class Patch_StockGenerator_RandomCountOf
    {
        static void Postfix(ref int __result, StockGenerator __instance)
        {
            ...
            if (currentMap != null && currentMap.IsPlayerHome && settlementScoreManager != null && settlementScoreManager.cachedStatistics.ContainsKey(currentMap))
            {
                var statistics = settlementScoreManager.cachedStatistics[currentMap];
