    ...
    public class Building_SettlementCenter : Building
    {
        ...
        private void initGraphicAlternativesIfNecessary()
        {
            if (this.settlementCenter0 == null)
            {
                ...
                this.settlementCenter0 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "0", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                this.settlementCenter1 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "1", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                this.settlementCenter2 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "2", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                this.settlementCenter3 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "3", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                ...
                this.settlementCenter4 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "4", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                ...
                this.settlementCenter5 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "5", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
                ...
                this.settlementCenter6 = GraphicDatabase.Get(this.DefaultGraphic.GetType(), def.graphicData.texPath + "6", this.DefaultGraphic.Shader, this.DefaultGraphic.drawSize, this.DefaultGraphic.color, this.DefaultGraphic.colorTwo, null);
            }
        }
