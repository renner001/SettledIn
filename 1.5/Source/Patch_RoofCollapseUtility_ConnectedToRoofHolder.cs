...
namespace DanielRenner.SettledIn
{
    ...
    public static class Patch_RoofCollapseUtility_ConnectedToRoofHolder
    {
        public static bool Prefix(Map map, ref bool __result)
        {
            Log.DebugOnce("Patch for RoofCollapseUtility.ConnectedToRoofHolder() is getting called...");
