...
{
    class ModSettings_SettledIn : ModSettings
    {
        ...
        {
            /*
            Rect descriptionRect = rect.TopPartPixels(Text.CalcHeight(Translations_SettledIn.Static.SettingsPanelChangeSettingsEffect, rect.width));
            Rect mainRect = rect.BottomPartPixels(rect.height - descriptionRect.height - 50);
            Widgets.Label(descriptionRect, Translations_SettledIn.Static.SettingsPanelChangeSettingsEffect);
        ...
        public override void ExposeData()
        {
            ...
            {
                Log.Debug("ModSettings_SettledIn.ExposeData() post load init called");
            }
