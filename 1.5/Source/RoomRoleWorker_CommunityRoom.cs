...
namespace DanielRenner.SettledIn
{
    class RoomRoleWorker_CommunityRoom : RoomRoleWorker_DynamicBase
    {
        ...
        public override float GetScore(Room room)
        {
            ...
            var recScore = DefDatabase<RoomRoleDef>.GetNamed("RecRoom").Worker.GetScore(room);
            var diningScore = DefDatabase<RoomRoleDef>.GetNamed("DiningRoom").Worker.GetScore(room);
